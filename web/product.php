...
<!---->
<div class="container">
	<h6 class="dress"><a href="index.php">Inicio</a> <i> </i> Dress &amp; T-shirt </h6>
</div>
<div class="back">
	<h2>Productos</h2>
</div>
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/be.jpg" alt=""></a>
...
amet consectetuer  </a></h6>
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/be1.jpg" alt=""></a>
...
amet consectetuer </a></h6>
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/be2.jpg" alt=""></a>
		        ...
		        <div class="product-right-top">
		        	<div class="top-product">
		        		<div class="col-md-4 chain-grid  simpleCart_shelfItem">
	   		     		...
	   		     		<a  href="single.php"><img class="img-responsive " src="images/pr.jpg" alt=" ">
	   		     			<div class="link">
	   		     			<ul >
										<li><i> </i></li>
	   		     		...
	   		     		<div class="grid-chain-bottom ">
	   		     			<h6><a href="single.php">WOO JACKET #1</a></h6>
	   		     	...
	   		     	<div class="col-md-4 chain-grid simpleCart_shelfItem">
					<div class="grid-span-1">
	   		     		<a href="single.php"><img class="img-responsive " src="images/pr1.jpg" alt=" ">
						<div class="link">
	   		     			<ul >
										<li><i> </i></li>
										<li><i class="white1"> </i></li>
	   		     	...
	   		     	<div class="col-md-4 chain-grid simpleCart_shelfItem">
					<div class="grid-span-1">
	   		     		<a href="single.php"><img class="img-responsive " src="images/pr2.jpg" alt=" ">
						<div class="link">
	   		     			<ul >
										<li><i> </i></li>
										<li><i class="white1"> </i></li>
		        	...
		        	<div class="top-product">
		        		...
		        		<div class="col-md-4 chain-grid simpleCart_shelfItem">
						<div class="grid-span-1">
	   		     		<a href="single.php"><img class="img-responsive " src="images/pr7.jpg" alt=" ">
						<div class="link">
	   		     			<ul >
										<li><i> </i></li>
										<li><i class="white1"> </i></li>
					...
					<div class="grid-span-1">
	   		     		<a href="single.php"><img class="img-responsive " src="images/pr4.jpg" alt=" ">
						<div class="link">
	   		     			<ul >
										<li><i> </i></li>
										<li><i class="white1"> </i></li>
	   		     	...
	   		     	<div class="col-md-4 chain-grid simpleCart_shelfItem">
					<div class="grid-span-1">
	   		     		<a href="single.php"><img class="img-responsive " src="images/pr5.jpg" alt=" ">
						<div class="link">
	   		     			<ul >
										<li><i> </i></li>
										<li><i class="white1"> </i></li>
		        	...
		        	<div class="top-product">
		        		...
		        		<div class="col-md-4 chain-grid simpleCart_shelfItem">
						<div class="grid-span-1">
	   		     		<a href="single.php"><img class="img-responsive " src="images/pr6.jpg" alt=" ">
						<div class="link">
	   		     			<ul >
										<li><i> </i></li>
										<li><i class="white1"> </i></li>
...
It is based on Bootstrap.</p>
			...
			<div class="clearfix"> </div>
			<p class="footer-class">© 2016 BorkStore. All Rights Reserved.</p>
		</div>
	</div>
<!---->
</body>
